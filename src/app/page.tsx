					...
					<section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-sky-200 via-blue-200 to-indigo-200 px-6 py-10 text-slate-800 shadow-2xl sm:px-7 sm:py-12">
						...
						<div className="relative z-10 max-w-3xl">
							...
							{/* <p className="mt-4 max-w-2xl text-base text-white/80 sm:text-lg">
								Pantau izin siswa dari delapan kelas secara real-time, percepat proses persetujuan,
								dan pastikan semua data terdokumentasi rapi dalam satu tampilan elegan.
							</p> */}
								...
								<div className="flex flex-col gap-4 lg:flex-row lg:items-center lg:justify-between">
									...
									<div className="flex flex-col gap-3 sm:flex-row sm:items-center">
										<div className="relative w-full sm:w-auto">
											...
											/>
											{/* <span className="pointer-events-none absolute right-4 top-1/2 -translate-y-1/2 text-xs uppercase tracking-[0.3em] text-slate-300">
												FIND
											</span> */}
										</div>
										<button
